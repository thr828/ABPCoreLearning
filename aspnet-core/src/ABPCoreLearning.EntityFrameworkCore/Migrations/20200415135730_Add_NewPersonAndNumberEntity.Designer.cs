...
namespace ABPCoreLearning.Migrations
{
    ...
    [Migration("20200415135730_Add_NewPersonAndNumberEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABPCoreLearning.PhoneBooks.Persons.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ABPCoreLearning.PhoneBooks.PhoneNumbers.PhoneNumber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ABPCoreLearning.PhoneBooks.PhoneNumbers.PhoneNumber", b =>
                {
                    b.HasOne("ABPCoreLearning.PhoneBooks.Persons.Person", "Person")
                        .WithMany()
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ABPCoreLearning.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ABPCoreLearning.Authorization.Users.User", null)
                        .WithMany("Claims")
